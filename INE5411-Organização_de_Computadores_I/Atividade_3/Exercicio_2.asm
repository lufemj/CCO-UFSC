...
LOOP_COLUNA:
	...
	mul $t2, $t0, 64		#Multiplica o valor da linha por 64 para encontrar a posição correta no endereço
	mul $t3, $t1, 4			#Multiplica o valor da coluna por 4 para encontrar a posição correta no endereço
	add $t3, $t2, $t3		#Soma esse dois valores e armazena o resultado em $t3
