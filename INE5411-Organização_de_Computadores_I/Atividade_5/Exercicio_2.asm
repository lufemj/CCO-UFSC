#Alunos: Luis Fernando Mendon�a Junior	Matricula: 22103512
#	Isaque Floriano Beirith		Matricula: 22100624
#Atividade 5	Exerc�cio 2
...
MAIN:
	...
	syscall
	move	$s0, $v0		#Armazena o endere�o da matriz A retornado

	li	$v0, 9			#C�digo 9 utilizado para alocar mem�ira
	move	$a0, $t1		#Passa o tamanho da matriz em bytes
	syscall
	move	$s1, $v0		#Armazena o endere�o da matriz B retornado
...
LOOP_JJ:
	...
	mul	$t6, $t6, 4		#Multiplica esse valor por 4 para encontrar a posi��o no endere�o
	add 	$t6, $t6,$s0		#Soma a posi��o encontrada com o endere�o da matriz A
	...
	mul	$t7, $t7, 4		#Multiplica esse valor por 4 para encontrar a posi��o no endere�o
	add 	$t7, $t7, $s1		#Soma a posi��o encontrada com o endere�o da matriz B
		
	#Opera��o e armazenamento
	l.s	$f0, ($t6)		#Carrega o valor da posi��o atual da matriz A
	l.s	$f1, ($t7)		#Carrega o valor da posi��o atual da matriz B
